...
using App.Application.Features.CategoryFeatures.QueryHandlers;
using MediatR;
...
namespace App.Api.Controllers
{
    ...
    public class CategoryController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Create(CreateCategoryCommand commend)
        {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Update(string id, UpdateCategoryCommand commend)
        {
            commend.id = id;
            var result = await _mediator.Send(commend);
            return StatusCode((int)HttpStatusCode.Created, result);
